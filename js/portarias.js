...
function fichaTecnicaHtml(f, uf) {
  return `<a href="#" onclick="abrirFichaTecnica('${uf}');return false;" style="color:var(--roxo);font-weight:600;text-decoration:underline;cursor:pointer;">Ficha Técnica Institucional</a>`;
}
